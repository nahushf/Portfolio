...
import { lerp, getMousePos, calcWinsize, distance } from './buttonUtils';
...
export default class ButtonCtrl extends EventEmitter {
    ...
    render() {
        ...
        this.DOM.text.style.transform = `translate3d(${-this.renderedStyles['tx'].previous * 0.6}px, ${-this
            .renderedStyles['ty'].previous * 0.6}px, 0)`;
